 ...
 */
class Fuel2Burnig extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_fueltype', 'id_burningtype', 'EmissionCO', 'EmissionNO', 'mechanical_shortage', 'EmissionNMLOC',], 'required'],
            [['id_fueltype', 'id_burningtype'], 'integer'],
            [['EmissionCO', 'EmissionNO', 'mechanical_shortage', 'EmissionNMLOC',], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'id_fueltype' => Yii::t('main','Id Fueltype'),
            'id_burningtype' => Yii::t('main','Id Burningtype'),
            'EmissionCO' => Yii::t('main','Emission Co'),
            'EmissionNO' => Yii::t('main','Emission No'),
            'mechanical_shortage' => Yii::t('main','Mechanical Shortage'),
            'EmissionNMLOC' => Yii::t('main', 'EmissionNMLOC'),
        ];
    }
